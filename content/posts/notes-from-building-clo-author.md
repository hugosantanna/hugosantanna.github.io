...
draft: false
summary: "Kicking off a series of notes on building [Clo-Author](https://github.com/hugosantanna/clo-author)."
categories: ["notebook"]
...
The novelty in the architecture is actually pretty simple. It's around **worker-critic pairs**: every phase in the research pipeline has a worker-critic pair: the worker creates and cannot audit; the critic audits and cannot edit. One pair for literature review, another for data search, etc.

Picture Karl Popper's epistemology, raised by the Separatist Army.

![Battle droids from the Separatist Army](/images/clo-author-separatists.jpg)
